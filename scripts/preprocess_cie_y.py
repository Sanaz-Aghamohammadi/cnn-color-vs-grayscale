...
def convert_to_cie_y_grayscale(input_path: Path, output_path: Path) -> None:
    """
    Read one image, convert it to linear CIE Y grayscale, and save it.
    """
    ...
    # Apply CIE Y grayscale method
    gray = cie_y_grayscale(img_rgb)
...
def process_classified_split(split_name: str) -> None:
    ...
    output_root = Path("data/processed/cie_y/flowers") / split_name
    ...
    for class_folder in sorted(class_folders):
        ...
        for image_path in image_paths:
            ...
            convert_to_cie_y_grayscale(image_path, output_path)
            total_images += 1
...
def main() -> None:
    ...
    print("\nAll CIE Y preprocessing complete.")
